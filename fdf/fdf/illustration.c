...
/*   Updated: 2023/01/04 19:41:09 by yugurlu          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		float y_end)
{
	...
	y_start = (x_start + y_start) * sin(1) - (z_start * data->depth);
	x_end = (x_end - y_end) * cos(1);
	y_end = (x_end + y_end) * sin(1) - (z_end * data->depth);
